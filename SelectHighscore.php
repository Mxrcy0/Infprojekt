...
$sql = "SELECT hscore FROM score WHERE pID = $pID";
$result = $conn->query($sql);

//store the result on the $hscore variable and then return it using the json_encode function
$hscore_row = mysqli_fetch_array($result);
$hscore = $hscore_row['elo'];
$response_array['hscore'] = $hscore;
